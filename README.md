...
![Ansible](https://img.shields.io/badge/Ansible-EE00FF?style=flat-square&logo=ansible&logoColor=white)
...
<details open>
<summary><b>Junior DevOps Engineer</b> @ CrunchOps | <code>Sep 2024 - Present</code> 📍 Bengaluru, India</summary>

> **Tech Stack:** `Kubernetes` `Jenkins` `GitHub Actions` `Docker` `AWS` `Shell Scripting` `Git`

- 🐳 Managed Kubernetes-based container orchestration for 15+ application deployments across dev, staging, and production environments
- 🔄 Built and maintained enterprise CI/CD pipelines using Jenkins and GitHub Actions, reducing deployment time by 40%
- 📦 Containerized 20+ applications using Docker with optimized Dockerfiles, improving consistency across all environments
- 🤖 Automated routine operational tasks using Shell scripting, saving 10+ hours per week on manual operations
- 🔧 Collaborated with development teams to troubleshoot deployment issues, achieving 99.5% uptime SLA

</details>

<details>
<summary><b>DevOps Intern</b> @ CrunchOps | <code>Jun 2024 - Aug 2024</code> 📍 Bengaluru, India</summary>

> **Tech Stack:** `CI/CD` `Docker` `Git` `AWS` `Linux`

- 🚀 Assisted in setting up enterprise CI/CD pipelines, reducing manual build processes by 80%
- 🐳 Supported Docker image creation and container lifecycle management for 10+ microservices
- 📝 Worked with Git-based workflows for version control and cross-team collaboration
- ☁️ Gained hands-on exposure to AWS services including EC2, IAM, S3, and RDS

</details>

<details>
<summary><b>DevOps Intern</b> @ Scope India | <code>Oct 2023 - Mar 2024</code> 📍 Thiruvananthapuram, India</summary>

> **Tech Stack:** `Linux Administration` `AWS` `Networking` `CCNA Concepts`

- 🌐 Mastered networking fundamentals including IP addressing, routing, VLANs, and switching concepts
- ☁️ Built foundational knowledge of AWS services (EC2, S3, IAM, VPC) through hands-on labs
- 🐧 Practiced Linux system administration including user management, permissions, and file systems
- 📚 Completed CCNA fundamentals training with focus on enterprise networking
...
|---------|-------|-----------|
| **Scalable Java App Deployment on AWS** | Terraform, Packer, Ansible, Python Boto3 | Deployed IaC-based Java application infrastructure • Auto-scaling AMI creation • Automated credential management via AWS Secrets Manager • 100% infrastructure reproducibility |
| **Jenkins Auto-Scaling Infrastructure** | Jenkins, AWS, ALB, EFS, IAM | Highly available CI/CD on Auto Scaling Group • Persistent data with Amazon EFS • Secure IAM role-based access • 99.9% uptime with static DNS endpoint |
| **Container Orchestration on Kubernetes** | Kubernetes, Docker, Helm | Multi-environment K8s deployment • Self-healing and auto-scaling pods • Load balancing and service discovery • 30% reduction in resource costs |
